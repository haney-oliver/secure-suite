...
Revision ID: 8b12feef6009
Revises: 
Create Date: 2020-06-19 19:21:55.825797
...
def upgrade():
    ...
    sa.Column('role_key', sa.String(length=36), nullable=False),
    ...
    sa.Column('permission_key', sa.String(length=36), nullable=False),
    sa.Column('ref_role_key', sa.String(length=36), nullable=True),
    sa.Column('permission_name', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['ref_role_key'], ['role.role_key'], ),
